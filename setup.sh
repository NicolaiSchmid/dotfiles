...
sudo pacman -Sy
sudo pacman -Sy base-devel pacaur curl dnsutils go net-tools gnu-netcat traceroute wireshark-qt whois
...
pacaur -Sy yarn docker git google-chrome yubikey-manager yubikey-personalization libu2f-host yubikey-personalization-gui-git vivaldi kubectl minikube zsh visual-studio-code-bin spotify slack-desktop insomnia telepresence-git antigen-git kubernetes-helm-bin grc keybase robo3t-bin
